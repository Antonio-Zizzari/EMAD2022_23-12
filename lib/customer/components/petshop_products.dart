...
class _PetShopProductsPageState extends State<PetShopProductsPage> with TickerProviderStateMixin {
  ...
  var selectedRange = RangeValues(20.00, 200.00);
        ...
        slivers: [
          ...
          SliverList(
            delegate: SliverChildListDelegate([
              ...
              //         mainAxisAlignment: MainAxisAlignment.spaceBetween,
              //         children: [
              //           Text('Cotton Collection', style: TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.bold, inherit: false, letterSpacing: 1),),
              //           Padding(
              //             padding: EdgeInsets.only(right: 20.0),
              //             child: Text('Vedi tutti i prodotti ', style: TextStyle(color: Colors.black, fontSize: 14, inherit: false),),
              //           ),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20,),
              Text(product.name,
                style: TextStyle(color: Colors.black, fontSize: 18, inherit: false),
              ),
              SizedBox(height: 10,),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text(product.description, style: TextStyle(color: Colors.orange.shade400, fontSize: 14,  inherit: false),),
                  Text("€ " +product.price.toString() + '.00',
                    style: TextStyle(color: Colors.black, fontSize: 18, fontWeight: FontWeight.w800,  inherit: false),
                  ),
                ],
              ),
            ],
              ...
              Expanded(
                child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 5,),
                      Text(product.description, style: TextStyle(color: Colors.orange.shade400, fontSize: 13, inherit: false),),
                      SizedBox(height: 10,),
                      Text("€ " +product.price.toString() + '.00',
                        style: TextStyle(color: Colors.black, fontSize: 18, fontWeight: FontWeight.w800, inherit: false),
                      ),
