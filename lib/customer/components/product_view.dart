          ...
          slivers: [
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                  ...
                  background: Image.asset(widget.product.imagePath, fit: BoxFit.cover,)
              ),
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 5,),
                                  Text(widget.product.description, style: TextStyle(color: Colors.orange.shade400, fontSize: 14,),),
                                ],
                              ),
