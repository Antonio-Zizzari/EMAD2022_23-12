...
class PetItem extends StatelessWidget {
  const PetItem({ Key? key, required this.data, required this.index, this.width = 350, this.height = 400,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            getAttribute(Icons.transgender, data.sesso,),
                            getAttribute(Icons.query_builder, data.eta,),
                          ],
                        ),
                      ],
                    )
  ...
  getAttribute(IconData icon, String info){
    return
      Row(
        children: [
          Icon(icon, size: 18, color: Color.fromRGBO(255, 255, 255, 1),),
          SizedBox(width: 3,),
          Text(info, maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(color: Color.fromRGBO(255, 255, 255, 1), fontSize: 13),),
        ],
      );
  }
}